...
def Create_Redshift_Material(rs, doc, mat_name, surface_maps):
    if rs is False:
        return
...
def surface_maps_redshift(rs, doc, asset, selectedVariants):
    # explode variants
    ...
    for variantConfig in variantConfigs:
        ...
        Create_Redshift_Material(rs, doc, mat_name, surface_maps)
